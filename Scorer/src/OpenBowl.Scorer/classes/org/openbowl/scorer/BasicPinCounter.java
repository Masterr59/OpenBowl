...
public class BasicPinCounter implements PinCounter
{
     ...
     * 
     * @throws IllegalArgumentException on duplicate pin number or out-of-bounds x/y positions
     */
    ...
    /**
     * Opens a GUI dialog that allows the use to configure the pin counter settings
     */
    @Override
    ...
    /**
     * Removes the PinCounterTarget with the pin number equal to the "pin" parameter
     * 
     * @param pin The pin number (BowlingPins) of the PinCounterTarget to be removed
     * 
     * @return True if a PinCounterTarget with the provided pin number was removed,
     *         false if no PinCounterTarget with the pin number was found
     */
