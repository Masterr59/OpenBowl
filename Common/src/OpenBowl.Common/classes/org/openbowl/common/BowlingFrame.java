...
public class BowlingFrame {
    ...
    private final ScoreType[] mScoreTypes;
    ...
    public BowlingFrame(boolean is10thFrame) {
        ...
        mScoreTypes = new ScoreType[3];
        for (int i = 0; i < 3; i++) {
            mBalls[i] = Ball.NOTUSED;
            mBallSpeeds[i] = 0.0;
            mPins[i] = new ArrayList<>();
            mScoreTypes[i] = ScoreType.NONE;
        }
        mCurrentBallIndex = 0;
        mIsFinished = false;
    }
    ...
    public void addBall(ArrayList<BowlingPins> remainingPins, boolean foul, double speed) {
        if (!mIsFinished) {
            switch (mCurrentBallIndex) {
                case 0:
                    addFirstBall(remainingPins, foul, speed, ScoreType.MECHANICAL);
                    break;
                case 1:
                    addSecondBall(remainingPins, foul, speed, ScoreType.MECHANICAL);
                    break;
                default:
                    addThirdBall(remainingPins, foul, speed, ScoreType.MECHANICAL);
                    break;
            }
        }
    ...
    private void addFirstBall(ArrayList<BowlingPins> remainingPins, boolean foul, double speed, ScoreType type) {
    ...
    private void addSecondBall(ArrayList<BowlingPins> remainingPins, boolean foul, double speed, ScoreType type) {
        int pinsRemaining = remainingPins.size();
    ...
    private void addThirdBall(ArrayList<BowlingPins> remainingPins, boolean foul, double speed, ScoreType type) {
        int pinsRemaining = remainingPins.size();
